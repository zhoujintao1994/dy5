					...
					<div class="row">
												...
												<div class="widget-body am-fr">
													...
													<form class="am-form tpl-form-line-form">
														...
														<div class="am-form-group">
															...
															<div class="am-u-sm-9">
																<input type="text" class="tpl-form-input" id="inCardNum"
														...
														<div class="am-form-group">
															...
															<div class="am-u-sm-9">
																<input type="sum" class="tpl-form-input" id="sum"
																	placeholder="请输入金额"> <small></small>
															</div>
														</div>
														...
														<div class="am-form-group">
															...
															<div class="am-u-sm-9">
																<input type="password" class="tpl-form-input"
																	id="passWord" placeholder="请输入银行卡密码"> <small></small>
															</div>
														</div>
												</div>
						...
						<div class="am-modal am-modal-alert" tabindex="-1" id="my-alert">
							<div class="am-modal-dialog">
								...
								<div class="am-modal-bd" id="successAlet">转账成功</div>
			...
			<script type="text/javascript">
				...
				function transfer() {
					var param = {
						...
						outCardNum : $('#cardNumber').val(),
						passWord : $('#passWord').val()
					};

					$.post('/card/transfer.do', param, callback);
